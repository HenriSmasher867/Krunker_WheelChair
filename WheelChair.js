...
alert("INJECTED Wheel Chair")
//Hub change
document.title = "YT: ZaresPlus X";
...
document.getElementById("texts3DHolder").innerHTML = 'Get more hack at ZaresPlus X Channel';
...
// Chat messege 
document.getElementById('chatList').innerHTML = '<div class="chatItem" style="word-break:break-all;overflow-wrap:break-word;"><span class="chatMsg"><span style="color:#ffff00">YT: ZaresPlus X</span><img style="opacity:2.0;margin-right:9px;" <span style="color:#00FFFF">V.3.4 ZaresPlus X</span><div class="chatItem" style="word-break:break-all;overflow-wrap:break-word;"><span class="chatMsg"><img style="opacity:0.7;margin-right:9px;"<span style="color: #ffff00">Hack is powered by wheel chair (HRT) Dont be evil. Use your hacks smart. With number 1 you open menu)</span></span></span></div></div>';
...
(function () {
    ...
    const options = {
        ...
        autoReload: true,
        autoJump: true,
        chamsColorStr: "rgba(255,244,87,1)",
        chamsRed: 255,
        chamsBlue: 0,
        chamsGreen: 0,
    };
